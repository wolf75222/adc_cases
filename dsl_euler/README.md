...
- **PROUVE / mesure** : la bulle se **detend** : la pression au sommet chute de $p_c(0)=1.395$, passe
  ...
  est constitue), puis decroit vers la valeur asserее `moved`$=0.394$. C'est la "decroissance d'une
...
## 6. Ce qui manque pour promouvoir ce prototype (analyse honnete des limites)
