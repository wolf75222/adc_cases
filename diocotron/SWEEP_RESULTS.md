...
- **l = 3 : le signal le plus PROPRE. L'ordre reduit le gap, mais a haute resolution O5 APLATIT
  ...
  SUGGERE un plancher residuel de l'ordre de ~9 % qui ne se referme pas par la resolution (candidat
...
l'ensemble des donnees est donc que les DONNEES SUGGERENT un plancher residuel l-dependant de l'ordre
...
prudent de PR-0 SUGGERE seulement, et reste a confirmer.
