...
Cette demo pilote depuis Python la facade compilee `adc` (toute la physique est en
C++). On instancie le solveur AMR `DiocotronAmrSolver` qui simule la meme instabilite
...
def main():
    ...
    solver = adc.DiocotronAmrSolver(cfg)
