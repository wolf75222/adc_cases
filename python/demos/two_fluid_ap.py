...
On pilote depuis Python la facade compilee `adc` (toute la physique est en C++). Le
TwoFluidAPSolver integre deux fluides charges (electrons + ions) couples au champ
...
def run_stiff():
    ...
    solver = adc.TwoFluidAPSolver(cfg)
